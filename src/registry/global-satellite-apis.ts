...
export const popularApis: SatelliteApi[] = [
  {
    ...
    notes:
      "Classic Sentinel Hub processing API (OAuth). For catalog-only Sentinel-1/2 over Thailand prefer native CDSE STAC (copernicus-cdse-stac) — no processing key required for search.",
    tier: "popular",
  ...
  },
  {
    ...
    notes:
      "Planetary analysis platform (Python ee / JS). Free noncommercial EECU quota is for research, education, and nonprofit analysis — not a production government tile CDN. Operational civic apps need https://earthengine.google.com/commercial/ . See docs/FREE-EO-SOURCES.md.",
    tier: "popular",
    docsUrl: "https://earthengine.google.com/noncommercial/",
    imageryFallback: false,
  },
  {
    id: "copernicus-cdse-stac",
    name: "Copernicus Data Space Ecosystem STAC",
    agency: "ESA / European Commission",
    country: "EU",
    rootUrl: "https://stac.dataspace.copernicus.eu/v1",
    endpoints: [
      { path: "/search", description: "STAC item search (public catalog)" },
      { path: "/collections/sentinel-2-l2a", description: "Sentinel-2 Level-2A collection" },
      { path: "/collections/sentinel-1-grd", description: "Sentinel-1 Ground Range Detected collection" },
    ],
    protocol: "STAC",
    auth: "none",
    domain: ["catalog", "imagery", "sar"],
    coverage: "Global Copernicus Sentinel missions",
    satellites: ["Sentinel-1", "Sentinel-2", "Sentinel-3", "Sentinel-5P"],
    notes:
      "Native CDSE catalog (not Sentinel Hub processing). Legacy https://catalogue.dataspace.copernicus.eu/stac deprecated 17 Nov 2025. Asset download uses CDSE identity; search does not. Docs: https://documentation.dataspace.copernicus.eu/APIs/STAC.html",
    tier: "popular",
  ...
  },
  {
    ...
    agency: "NASA Langley",
    country: "US",
    rootUrl: "https://power.larc.nasa.gov/api",
    endpoints: [
      { path: "/temporal/daily/point", description: "Daily point time series (T2M, precip, solar, …)" },
      { path: "/temporal/hourly/point", description: "Hourly point time series" },
    ],
    protocol: "REST",
    auth: "none",
    domain: ["meteorological"],
    coverage: "Global analysis-ready climate fields",
    satellites: ["GEOS / POWER (model)"],
    notes:
      "Free, no auth, CC BY 4.0. Modelled meteorological fields (~0.5°), not station gauges and not SMAP soil moisture. Docs: https://power.larc.nasa.gov/docs/services/api/temporal/daily/",
    tier: "popular",
    docsUrl: "https://power.larc.nasa.gov/docs/services/",
  },
  {
    id: "nasa-gibs",
    ...
    satellites: ["VIIRS", "MODIS Terra/Aqua", "IMERG", "OMI", "AIRS", "MISR", "SMAP"],
    notes: "Primary free satellite tile source. No auth required. 1,000+ layer catalog including SMAP L4 soil-moisture browse. Used as the backbone of this toolkit.",
    tier: "popular",
...
export const nicheApis: SatelliteApi[] = [
  ...
  {
    id: "jaxa-gsmap",
    name: "JAXA GSMaP Global Rainfall Watch",
    agency: "JAXA EORC",
    country: "JP",
    rootUrl: "https://sharaku.eorc.jaxa.jp/GSMaP/",
    endpoints: [
      { path: "/", description: "Realtime / rainfall-watch viewer" },
      { path: "/guide.html", description: "Product guide" },
    ],
    protocol: "REST",
    auth: "registration",
    domain: ["meteorological"],
    coverage: "60N–60S satellite precipitation estimates, ~0.1°",
    satellites: ["GPM constellation", "Himawari IR support"],
    notes:
      "Satellite-estimated rainfall (algorithm), not rain gauges. FTP after free JAXA registration. Himawari science data: https://www.eorc.jaxa.jp/ptree/",
    tier: "niche",
    docsUrl: "https://sharaku.eorc.jaxa.jp/GSMaP/guide.html",
  },
  {
    id: "gistda-gateway",
    ...
    endpoints: [
      { path: "/features/flood/{1day,3days,7days,30days}", description: "Flood feature GeoJSON" },
      { path: "/features/flood-freq", description: "Flood frequency features" },
      { path: "/features/water_hyacinth", description: "Water hyacinth features" },
      { path: "/features/viirs/{1day,3days,7days,30days}", description: "VIIRS thermal features" },
      { path: "/features/burn-scar", description: "Burn-scar features" },
      { path: "/features/burn-freq", description: "Burn-frequency features" },
      { path: "/maps/flood/{1day,3days,7days,30days}/{wms|wmts|tms/{z}/{x}/{y}}", description: "Flood map tiles" },
      { path: "/maps/flood-freq/{wms|wmts|tms/{z}/{x}/{y}}", description: "Flood-frequency tiles" },
      { path: "/maps/viirs|burn-scar|burn-freq/...", description: "Fire map tiles matching feature feeds" },
      { path: "/maps/dri|ndwi|smap/7days/{wms|wmts|tms/{z}/{x}/{y}}", description: "Drought 7-day tiles" },
    ],
    protocol: "REST",
    auth: "api-key",
    domain: ["imagery", "catalog"],
  ...
  {
    id: "gistda-gflood",
    name: "GISTDA Disaster Platform maps",
    agency: "GISTDA",
    country: "TH",
    rootUrl: "https://api-gateway.gistda.or.th/api/2.0/resources",
    endpoints: [
      { path: "/maps/flood/{1day,3days,7days,30days}/{wms|wmts|tms/{z}/{x}/{y}}", description: "Primary live flood tiles" },
      { path: "/maps/flood-freq/{wms|wmts|tms/{z}/{x}/{y}}", description: "Flood-frequency tiles" },
      { path: "/maps/viirs/{1day,3days,7days,30days}/{wms|wmts|tms/{z}/{x}/{y}}", description: "VIIRS thermal tiles" },
      { path: "/maps/burn-scar/{wms|wmts|tms/{z}/{x}/{y}}", description: "Burn-scar tiles" },
      { path: "/maps/burn-freq/{wms|wmts|tms/{z}/{x}/{y}}", description: "Burn-frequency tiles" },
      { path: "/maps/dri|ndwi|smap/7days/{wms|wmts|tms/{z}/{x}/{y}}", description: "Drought 7-day tiles" },
    ],
    protocol: "WMTS",
    auth: "api-key",
    domain: ["imagery"],
    coverage: "Thailand flood / fire / drought map services",
    satellites: ["GISTDA disaster mapping"],
    notes:
      "Disaster Platform Open API maps (2026-09-02 inventory). Docs: https://disaster.gistda.or.th/services/open-api . A separate ArcGIS GFlood folder still hosts the 2011 Flood_Y2011 cache. Attribute GISTDA. Do not call /app-api/proxy.",
    tier: "niche",
    docsUrl: "https://disaster.gistda.or.th/services/open-api",
    imageryFallback: true,
  },
...
export const portalOnlyAgencies: PortalOnlyAgency[] = [
  ...
  {
    agency: "GISTDA (THEOS archive)",
    country: "Thailand",
    countryCode: "TH",
    offering: "THEOS-1/2 commercial/portal imagery",
    portalUrl: "https://www.gistda.or.th",
    reason:
      "THEOS scene archive remains portal/commercial. Disaster products are public: https://api-gateway.gistda.or.th/api/2.0/resources (docs https://disaster.gistda.or.th/services/open-api). See docs/FREE-EO-SOURCES.md.",
  },
  {
    agency: "PhilSA",
    country: "Philippines",
