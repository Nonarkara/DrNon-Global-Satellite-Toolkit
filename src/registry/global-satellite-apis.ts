...
export const nicheApis: SatelliteApi[] = [
  ...
  {
    id: "gistda-gflood",
    name: "GISTDA GFlood OGC",
    agency: "GISTDA",
    country: "TH",
    rootUrl: "https://gistdaportal.gistda.or.th/data/rest/services/GFlood",
    endpoints: [
      { path: "/GFlood_Inno_WMS/MapServer", description: "WMS: rain_30min, FloodArea_Poly, flood_prediction_union" },
      { path: "/GFlood_Inno_WMTS3857/MapServer", description: "WMTS/XYZ: Flood_Y2011 historical cache" },
    ],
    protocol: "WMTS",
    auth: "none",
    domain: ["imagery"],
    coverage: "Thailand flood mapping services",
    satellites: ["GISTDA GFlood"],
    notes:
      "Public ArcGIS REST. WMTS cache is the 2011 flood footprint, not live water. Prediction layer is modelled. Attribute GISTDA.",
    tier: "niche",
    docsUrl: "https://gistdaportal.gistda.or.th/data/rest/services/GFlood",
    imageryFallback: true,
  },
  {
    id: "roscosmos-stac",
...
export const portalOnlyAgencies: PortalOnlyAgency[] = [
  ...
  },
  {
    ...
    reason:
      "THEOS scene archive remains portal/commercial. Disaster products are NOT portal-only: use GISTDA API Gateway (https://api-gateway.gistda.or.th/v2) and GFlood OGC (https://gistdaportal.gistda.or.th/data/rest/services/GFlood). See docs/FREE-EO-SOURCES.md.",
  },
  {
    agency: "PhilSA",
    country: "Philippines",
